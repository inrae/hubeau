...
This network encompasses 3000+ observation sites, throughtou mainland France, that are streams selected to reflect the severity of drought events, i.e. that flow in "normal" conditions but dry out in case of drought. Being upstream the river basins, these sites are expected to act as 'sentinels' and sel_dataide early warning of the necessity of restricting water withdrawal in rivers and associated water tables. 
...
A survey encompasses a series of visual observations carried out at on stations at the "departement" grain. It is tagged as "usuelle" if it is a routine (i.e. around the 24th of the month from May to September), as "complémentaire" if not (e.g. during very dry periods).
